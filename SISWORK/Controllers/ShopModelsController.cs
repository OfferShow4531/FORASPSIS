...
namespace SISWORK.Controllers
{
    public class ShopModelsController : Controller
    {
        private readonly ApplicationDbContext _context;

        public ShopModelsController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,Name,price,type,Come")] ShopModel shopModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Name,price,type,Come")] ShopModel shopModel)
        {
            if (id != shopModel.id)
            {
                return NotFound();
